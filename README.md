...
- Agents:
  ...
  - SoloditBooster (HTTP adapter with offline fixtures)
  - LLMSynthesis (OpenAI-compatible vLLM adapter with offline fixtures)
...
# Optional: run HTTP adapters from offline fixtures
python -m ralph_wiggum.cli audit ./contracts --offline-fixtures
```
